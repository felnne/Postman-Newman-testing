...
# Project Settings
  hostname_project = "postman-newman"
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # VMs
  config.vm.define hostname_project + "-" + hostname_environment + "-" + "node1" + "." + domain_name do |vm1|

    vm1.vm.hostname = hostname_project + "-" + hostname_environment + "-" + "node1" + "." + domain_name  # Define hostname
